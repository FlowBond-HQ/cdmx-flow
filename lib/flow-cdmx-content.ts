...
export const copyEs: FlowSiteCopy = {
  metaTitle: "FLOW CDMX — 19 Junio · Ciudad de México",
  ...
  hero: {
    kicker: "19 Junio · MUV Lab · CDMX",
    title: "FLOW CDMX",
    lead: "El 19 de junio en MUV Lab, Ciudad de México. Parte de la experiencia Flow multi-ciudad: CDMX · Austin · Vallarta · Los Ángeles. Cine, música y tecnología regenerativa. Regístrate para recibir acceso prioritario cuando los boletos estén disponibles.",
    cta: "Regístrate",
    ctaSecondary: { label: "English version", href: "/sundance-mexico-city" },
  },
  about: {
    kicker: "Sobre el evento",
    title: "Un día de cine, música y tecnología regenerativa",
    paragraphs: [
      "Flow CDMX es la primera parada de una experiencia cultural multi-ciudad diseñada para celebrar el futuro del cine, la música y la tecnología regenerativa. El 19 de junio, Ciudad de México se convierte en el primer nodo de Flow Nation: una plataforma en expansión que conecta creadores, artistas, cineastas, músicos, líderes de bienestar y builders de tecnología regenerativa para vivir una experiencia inmersiva de un día en MUV Lab.",
  ...
  ticketsTitle: "Registro",
  ticketsLead: "Regístrate para recibir acceso prioritario cuando los boletos estén disponibles. Cupo limitado.",
  ticketsFootnote:
    "Te contactaremos en cuanto los boletos estén listos.",
  possibleArtists: {
    intro:
  ...
  program: {
    title: "Programa",
    body: "Un día en MUV Lab: círculo de cacao, la proyección de RIVUS (El Último Río Vivo) y el trailer de Los Plebes, breathwork, paneles de cine y cultura, poesía y spoken word, showcases de música en vivo y DJ sets con Tatewari y CrissyJ, talleres de bienestar, jam comunitario y ceremonia de integración. Programa completo próximamente.",
  },
  footer: {
    line1: "19 Junio · MUV Lab · CDMX",
    rights: "© 2026 FlowNation · cdmx.flownation.world",
  },
};

export const copyEn: FlowSiteCopy = {
  metaTitle: "FLOW CDMX — June 19 · Mexico City",
  nav: { labelEs: "Español", labelEn: "English", hrefEs: "/", hrefEn: "/sundance-mexico-city" },
  sections: {
    about: "Experience",
    aliados: "Partners",
  ...
  hero: {
    kicker: "June 19 · MUV Lab · Mexico City",
    title: "FLOW CDMX",
    lead: "June 19 at MUV Lab, Mexico City. Part of the Flow multi-city experience: CDMX · Austin · Vallarta · Los Angeles. Film, music, and regenerative technology. Register now for priority access when tickets are available.",
    cta: "Register",
  ...
  about: {
    ...
    paragraphs: [
      "FLOW CDMX is the first stop on a multi-city cultural journey built around film, music, and regenerative technology. On June 19, Mexico City becomes the first node of Flow Nation — a growing platform connecting creators, artists, filmmakers, musicians, wellness leaders, and regenerative tech builders for a fully immersive single-day experience at MUV Lab.",
  ...
  ticketsTitle: "Registration",
  ticketsLead: "Register for priority access when tickets are available. Limited capacity.",
  ticketsFootnote:
    "We’ll reach out as soon as tickets are ready.",
  possibleArtists: {
  ...
  program: {
    title: "Program",
    body: "One day at MUV Lab: a cacao circle, the RIVUS (The Last Living River) screening and the Los Plebes trailer, breathwork, film & culture panels, poetry and spoken word, live music showcases and DJ sets from Tatewari and CrissyJ, wellness workshops, a community jam, and an integration ceremony. Full program coming soon.",
  },
  footer: {
    line1: "June 19 · MUV Lab · Mexico City",
    rights: "© 2026 FlowNation · cdmx.flownation.world",
  },
};
...
export const ticketsEs: TicketTier[] = [
  {
    ...
    description: "Acceso a toda la programación del día en CDMX — proyecciones, conversaciones, música y momentos de comunidad.",
    ctaLabel: "Comprar",
...
export const ticketsEn: TicketTier[] = [
  {
    ...
    description: "Full-day access to programming in Mexico City — screenings, conversations, music, and community moments.",
    ctaLabel: "Buy",
    ctaHref: TICKETS_CHECKOUT,
  },
  {
