...
export const partnersEn: PartnerEntry[] = partnersShared.map((p, i) => {
  const descriptions: Record<number, string> = {
    ...
    3: "A Puerto Vallarta-rooted community connecting people to Flow through experiences, culture, and retreats across the region.",
...
export const ticketsEs: TicketTier[] = [
  ...
  },
  {
    name: "VIP · Pre-venta",
    priceLabel: "$777 MXN",
    secondaryLine: "Bebidas incluidas",
    featured: true,
  ...
  },
  {
    name: "General · Puerta",
    priceLabel: "$400 MXN",
    secondaryLine: "El día del evento",
    ctaLabel: "Link de boletos coming soon",
    ctaHref: TICKETS_COMING_SOON,
  },
  {
