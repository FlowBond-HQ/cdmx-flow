...
export const sponsorsCopyEs: SponsorsCopy = {
  ...
  finalBody:
    "Cuéntanos sobre tu marca y cómo te gustaría integrarte en Flow CDMX — el primer nodo de Flow Nation.",
...
export const sponsorsCopyEn: SponsorsCopy = {
  ...
  finalBody:
    "Tell us about your brand and how you’d like to plug into Flow CDMX — the first node of Flow Nation.",
